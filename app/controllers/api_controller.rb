...
class ApiController < ApplicationController
  ...
  def wry_group
    ...
    # end
    request = Gcapi.wry_group(wry_params)
    render json: request.to_json
  end
  ...
  def im_here
    ...
    # end
    request = Gcapi.im_here(loc_params)
    render json: request.to_json
  end
  ...
  def im_here_group
    ...
    # end
    request = Gcapi.im_here_group(loc_params)
    render json: request.to_json
  end
  ...
  def get_my_data
    ...
    # end
    request = Gcapi.get_my_data(get_and_im_params)
    render json: request.to_json
  end
  ...
  def im
    ...
    # end
    request = Gcapi.im(get_and_im_params)
    render json: request.to_json
  end
  ...
  def new_group
    ...
    # end
    request = Gcapi.new_group(new_group_params)
    render json: request.to_json
  end
  ...
  def add_user_to_group
    ...
    #   render json: request.to_json
    # end
    request = Gcapi.add_user_to_group(add_del_params)
    render json: request.to_json
  end
  ...
  def del_user_from_group
    ...
    #   render json: request.to_json
    # end
    request = Gcapi.del_user_from_group(add_del_params)
    render json: request.to_json
  end
  ...
  def leave_the_group
    ...
    #   render json: request.to_json
    # end
    request = Gcapi.leave_the_group(leave_params)
    render json: request.to_json
  end
  ...
  def my_data_update
    ...
    #   render json: request.to_json
    # end
    request = Gcapi.my_data_update(update_params)
    render json: request.to_json
  end
